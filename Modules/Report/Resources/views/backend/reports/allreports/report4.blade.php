    ...
    <div class="card-body">
        ...
        <x-backend.section-header>
            ...
            <x-slot name="subtitle">
                Movement report by Product Category, Sub-category, Product Name & Code
            </x-slot>
            <x-slot name="toolbar">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>UoM</th>
                                    <th>Opening stock</th>
                                    <th>Received during the period</th>
                                    <th>Issued during the period
                                    </th>
                                    <th>Closing stock (at central store, sub-stores,
                                        in-transit)</th>
                                </tr>
                            </thead>
                            <tbody>
