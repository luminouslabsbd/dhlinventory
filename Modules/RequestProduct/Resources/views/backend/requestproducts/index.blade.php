                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("requestproduct::text.name")
                            </th>
                            <th>
                                @lang("requestproduct::text.slug")
                            </th>
                            <th>
                                @lang("requestproduct::text.updated_at")
                            </th>
                            <th>
                                @lang("requestproduct::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("requestproduct::text.action")
                            </th>
                        </tr>
                    </thead>
